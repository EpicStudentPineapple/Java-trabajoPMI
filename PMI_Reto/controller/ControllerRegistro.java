...
public class ControllerRegistro {
	...
	private void continuarRegistro() {
		...
		if (dni.length() != 9) {
			JOptionPane.showMessageDialog(vistaRegistro, "El DNI debe tener 9 caracteres", "Error",
					JOptionPane.ERROR_MESSAGE);
			return;
		}

		if (!contraseña.equals(confirmarContraseña)) {
			JOptionPane.showMessageDialog(vistaRegistro, "Las contraseñas no coinciden", "Error",
					JOptionPane.ERROR_MESSAGE);
			return;
		}
